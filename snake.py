...
COLOR_SNAKE_HEAD = (203, 28, 137)      # rgb color for red
# This is the color of the rest of the snake.
COLOR_SNAKE = (25, 94, 174)           # rgb color for green
# This is the color for the snake's food.
COLOR_FOOD = (244, 118, 87)          # rgb color for orange
...
def create_food_position():
    ...
    """ 
    return (random.randrange(0,29),random.randrange(0,29))
...
def snake_ran_out_of_bounds(snake):
    ...
    """
    if snake[0][0] < 0 or snake[0][0] > GRID_WIDTH:
        return True
    if snake[0][1] < 0 or snake[0][1] > GRID_HEIGHT:
        return True
    return False
